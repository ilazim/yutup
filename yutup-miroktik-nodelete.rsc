...
# yutup v0.1
#
# This implementation is based on http://wiki.mikrotik.com/wiki/Sync_Address_List_with_DNS_Cache
...
# do not delete the IP from existing address list even if it's not found in the new dns cache.
#         :put ("   " . $listaddr . " not found in search, removing...")
#         remove $l
      } else={
         :put ($listaddr . " already found address in IPs")
